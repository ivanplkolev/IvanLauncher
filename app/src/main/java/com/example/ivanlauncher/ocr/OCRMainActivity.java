package com.example.ivanlauncher.ocr;
...
import static com.example.ivanlauncher.ocr.OcrCaptureActivity.TextBlockObject;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            if (requestCode == CAMERA_SCAN_TEXT) {
                ...
                String text2 = OCRCapture.Builder(this).getTextFromUri(pickedImage);
