...
public class ContactGroupMenu implements MenuInterface {
    ...
    public ContactGroupMenu(Context context, TextView tv, UserInterfaceEngine parent) {
        this.tv = tv;
    ...
    public void resetUI() {
        confirmed = false;
        currentPosition = 0;
        contacts = ContactsLoader.realodAllcontacts(context, group);
